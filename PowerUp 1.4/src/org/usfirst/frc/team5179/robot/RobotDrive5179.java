 ...
 */
@Deprecated
public class RobotDrive5179 implements MotorSafety {
   ...
   */
  public RobotDrive5179(final int leftMotorChannel, final int rightMotorChannel) {
   ...
   */
  public RobotDrive5179(final int frontLeftMotor, final int rearLeftMotor, final int frontRightMotor,
   ...
   */
  public RobotDrive5179(SpeedController leftMotor, SpeedController rightMotor) {
   ...
   */
  public RobotDrive5179(SpeedController frontLeftMotor, SpeedController rearLeftMotor,
